...
public interface AuthConfigurable {
    ...
    default @NotNull AuthConfig firstAuthConfig() {
        return Optional.ofNullable(authConfigs())
                .stream()
                .flatMap(Collection::stream)
                .findFirst()
                .orElseThrow(() -> new NoAuthorizationConfigurationException(format("[%s] No authorization configuration found.", getClass().getSimpleName())));
    }
}
